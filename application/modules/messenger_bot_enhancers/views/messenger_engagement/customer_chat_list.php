...
$builder_load_url = base_url("visual_flow_builder/load_builder/".$page_id.'/1/'.$media_type.'?type=messenger-engagement&plugin=customer_chat_plugin&action=messenger_engagement_plugin');
