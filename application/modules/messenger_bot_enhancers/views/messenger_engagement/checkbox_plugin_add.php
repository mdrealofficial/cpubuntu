	 					  ...
	 					  <div class="form-group col-12 col-md-4 <?php if(!$this->is_broadcaster_exist) echo 'hidden';?>">
	 					    <label class="d-block">
	 					      <?php echo $this->lang->line("select label"); ?>
	 					       ...
	 					       <a class="blue float-right pointer" page_id_for_label="" id="create_label_checkbox_plugin"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line("Create Label");?></a>
	 					    </label>
...
<script>
	...
	function changePageAction(page_id) {
		  $.ajax({
		  type:'POST' ,
