...
<div class="row multi_layout">  
              ...
              <div class="form-group">                
                ...
                <select class="form-control select2" id="page" name="page">        
                   ...
                   <?php 
                     ...
                     {
                        $elected_page = '';
                        $xpage_id = $xdata['page_id'].'-'.$xdata['social_media'];
                       echo '<optgroup label="'.$value['media_name'].'">';
                       foreach ($value['page_list'] as $key2 => $value2) 
                       {
                        if($key2==$xpage_id) $elected_page = 'selected';
                         echo "<option value='".$key2."' {$elected_page}>".$value2."</option>";
                       }
                       echo '</optgroup>';
                     } 
                   ?>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(e){
      $("#page").val("<?php echo $xdata['page_id']."-".$xdata['social_media'];?>").change();
